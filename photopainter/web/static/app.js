...
const I18N = {
  en: {
    ...
    "cache.intro": "Downloaded photos are cached. If Immich is unavailable, the frame uses the cache. Old entries are auto-purged every night at midnight. Each source keeps its own cache.",
  ...
  fr: {
    ...
    "cache.intro": "Les photos téléchargées sont mises en cache. Si Immich est indisponible, le cadre puisera dans le cache. Purge automatique des plus anciennes chaque nuit à minuit. Chaque source a son propre cache.",
